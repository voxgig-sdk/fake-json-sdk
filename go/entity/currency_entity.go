...
func NewCurrencyEntity(client *core.FakeJsonSDK, entopts map[string]any) *CurrencyEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CurrencyEntity) GetName() string { return e.name }
...
func (e *CurrencyEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CurrencyEntity) Deleted() bool {
	return e.deleted
}


func (e *CurrencyEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCurrencyEntity(e.client, opts)
}

func (e *CurrencyEntity) Data(args ...any) any {
...
func (e *CurrencyEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *CurrencyEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CurrencyEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CurrencyEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
func (e *CurrencyEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CurrencyEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CurrencyEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CurrencyEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
