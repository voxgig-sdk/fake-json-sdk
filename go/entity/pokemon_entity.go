...
func NewPokemonEntity(client *core.FakeJsonSDK, entopts map[string]any) *PokemonEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *PokemonEntity) GetName() string { return e.name }
...
func (e *PokemonEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *PokemonEntity) Deleted() bool {
	return e.deleted
}


func (e *PokemonEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewPokemonEntity(e.client, opts)
}

func (e *PokemonEntity) Data(args ...any) any {
...
func (e *PokemonEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Pokemon; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *PokemonEntity) DataTyped(data ...Pokemon) Pokemon {
	if len(data) > 0 {
		return typedFrom[Pokemon](e.Data(asMap(data[0])))
	}
	return typedFrom[Pokemon](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Pokemon (all fields
// optional at the wire level).
func (e *PokemonEntity) MatchTyped(match ...Pokemon) Pokemon {
	if len(match) > 0 {
		return typedFrom[Pokemon](e.Match(asMap(match[0])))
	}
	return typedFrom[Pokemon](e.Match())
}
...
func (e *PokemonEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *PokemonEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *PokemonEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// PokemonListMatch and returns []Pokemon. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *PokemonEntity) ListTyped(reqmatch PokemonListMatch, ctrl map[string]any) ([]Pokemon, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Pokemon](res), nil
}



func (e *PokemonEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *PokemonEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *PokemonEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *PokemonEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
