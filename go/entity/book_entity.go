...
func NewBookEntity(client *core.FakeJsonSDK, entopts map[string]any) *BookEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BookEntity) GetName() string { return e.name }
...
func (e *BookEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BookEntity) Deleted() bool {
	return e.deleted
}


func (e *BookEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBookEntity(e.client, opts)
}

func (e *BookEntity) Data(args ...any) any {
...
func (e *BookEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
func (e *BookEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BookEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "list",
		"ctrl":     ctrl,
...
func (e *BookEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "create",
		"ctrl":    ctrl,
...
func (e *BookEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
func (e *BookEntity) Remove(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":   "remove",
		"ctrl":     ctrl,
...
func (e *BookEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
