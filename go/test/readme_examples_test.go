...
const testSeed = `map[string]any{"entity": map[string]any{"book": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "currency": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "person": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "pokemon": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
