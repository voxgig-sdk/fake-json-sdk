...
func (sdk *FakeJsonSDK) OptionsMap() map[string]any {
...
func (sdk *FakeJsonSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *FakeJsonSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *FakeJsonSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FakeJsonSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *FakeJsonSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *FakeJsonSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("FakeJsonSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *FakeJsonSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *FakeJsonSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("FakeJsonSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
