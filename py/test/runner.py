...
class FakeJsonTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FakeJsonTestRunner.getenv("FAKEJSON_TEST_LIVE")
        override = FakeJsonTestRunner.getenv("FAKEJSON_TEST_OVERRIDE")
        ...
        explain = FakeJsonTestRunner.getenv("FAKEJSON_TEST_EXPLAIN")
