...
class FakeJsonTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FakeJsonTestRunner.getenv("FAKE_JSON_TEST_LIVE")
        override = FakeJsonTestRunner.getenv("FAKE_JSON_TEST_OVERRIDE")
        ...
        explain = FakeJsonTestRunner.getenv("FAKE_JSON_TEST_EXPLAIN")
