# FakeJson SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions FakeJsonSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both FakeJsonSDK(...) and FakeJsonSDK.test(...) become
#      FakeJsonSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "fakejson_sdk"
_SDK_CLASS = "FakeJsonSDK"
