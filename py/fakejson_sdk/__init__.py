...
from fakejson_sdk.utility import register

# Load features
from fakejson_sdk.feature.base_feature import FakeJsonBaseFeature
from fakejson_sdk.features import _has_feature, _make_feature
...
class FakeJsonSDK:
    ...
    def get_utility(self):
        return FakeJsonUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("FakeJsonSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Book(self, data=None) -> "BookEntity":
        ...
        from fakejson_sdk.entity.book_entity import BookEntity
    ...
    def Currency(self, data=None) -> "CurrencyEntity":
        ...
        from fakejson_sdk.entity.currency_entity import CurrencyEntity
    ...
    def Person(self, data=None) -> "PersonEntity":
        ...
        from fakejson_sdk.entity.person_entity import PersonEntity
    ...
    def Pokemon(self, data=None) -> "PokemonEntity":
        ...
        from fakejson_sdk.entity.pokemon_entity import PokemonEntity
