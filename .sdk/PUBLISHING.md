...
|---|---|---|
| `ts/` | @voxgig-sdk/fake-json-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/fake-json-sdk \
      --repository voxgig-sdk/fake-json-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/fake-json-sdk` shows it, and
`npm trust revoke @voxgig-sdk/fake-json-sdk --id=<id>` removes it.
