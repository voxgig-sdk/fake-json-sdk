...
class PrimaryUtilityTest < Minitest::Test
  ...
  def setup
    @runner = FakeJsonOmni.make_runner(TEST_JSON_FILE, FakeJsonSDK.test(nil, nil))
  ...
  def test_make_point_basic
    ...
    subject = lambda do |ctx|
      ...
      err.nil? ? point : FakeJsonOmni.errify(err)
    end
