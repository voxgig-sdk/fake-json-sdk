...
from projectname_sdk import FakeJsonSDK
from projectname_sdk.core.spec import FakeJsonSpec
from projectname_sdk.core.result import FakeJsonResult
from projectname_sdk.core.response import FakeJsonResponse
from projectname_sdk.core.operation import FakeJsonOperation
from projectname_sdk.core.error import FakeJsonError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import FakeJsonBaseFeature
...
class TestPrimaryUtility:
    ...
    def test_feature_init_basic(self):
        init_client = FakeJsonSDK.test(None, None)
        ...
        class TestInitFeature(FakeJsonBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(FakeJsonBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = FakeJsonSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = FakeJsonSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = FakeJsonSDK.test(None, setup_opts)
