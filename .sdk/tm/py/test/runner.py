...
class FakeJsonTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = FakeJsonTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = FakeJsonTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = FakeJsonTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
