...
from projectname_sdk.core.control import FakeJsonControl
...
class FakeJsonContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(r, FakeJsonResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, FakeJsonResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return FakeJsonError(code, msg, self)
