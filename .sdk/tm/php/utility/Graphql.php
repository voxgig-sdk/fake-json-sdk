...
class FakeJsonGraphql
{
    ...
    // equivalent.
    public static function body(FakeJsonContext $ctx): mixed
    {
    ...
    public static function errors(FakeJsonContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
