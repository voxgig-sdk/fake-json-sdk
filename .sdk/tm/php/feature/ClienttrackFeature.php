...
// FakeJson SDK clienttrack feature
...
class FakeJsonClienttrackFeature extends FakeJsonBaseFeature
{
    ...
    public function PostConstruct(FakeJsonContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'FakeJson-SDK';
