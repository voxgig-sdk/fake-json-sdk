...
// FakeJson SDK streaming feature
...
class FakeJsonStreamingFeature extends FakeJsonBaseFeature
{
    ...
    private function _iterate(FakeJsonResult $result): \Generator
    {
    ...
    private function _streamable(FakeJsonContext $ctx): bool
    {
