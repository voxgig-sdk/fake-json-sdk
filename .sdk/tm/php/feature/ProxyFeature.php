...
class FakeJsonProxyFeature extends FakeJsonBaseFeature
{
    ...
    public function init(FakeJsonContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (FakeJsonContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
