...
class FakeJsonRbacFeature extends FakeJsonBaseFeature
{
    ...
    private function _required(FakeJsonContext $ctx): ?string
    {
    ...
    private function _reject(FakeJsonContext $ctx, string $required): void
    {
    ...
    private function _track(FakeJsonContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
