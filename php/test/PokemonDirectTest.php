...
class PokemonDirectTest extends TestCase
{
    public function test_direct_list_pokemon(): void
    {
        $setup = pokemon_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-pokemon", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
