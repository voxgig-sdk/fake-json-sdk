...
// FakeJson SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = FakeJsonOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(FakeJsonOmni::structfix($now, Struct::undef()))
                        !== json_encode(FakeJsonOmni::structfix($val, Struct::undef()))) {
