...
// FakeJson SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (FakeJsonSDK::test)
...
{
    private const SDK_CLASS = 'FakeJsonSDK';
    ...
    private const SDK_BASE = 'fakejson_sdk';
