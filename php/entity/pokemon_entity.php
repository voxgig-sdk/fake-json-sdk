...
class PokemonEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new PokemonEntity($this->_client, $opts);
    }

    /**
     * @param Pokemon|array $args Pokemon data (assoc-array) to store.
     */
    ...
    /**
     * @return Pokemon|array The current Pokemon data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Pokemon fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Pokemon fields).
     */
     ...
     *
     * @param PokemonListMatch|array|null $reqmatch Match filter (any subset
     *   of Pokemon fields) as an assoc-array; PokemonListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Pokemon[]|array A list of Pokemon items as assoc-arrays at
