...
// FakeJson SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class FakeJsonMakeRequest
{
    public static function call(FakeJsonContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new FakeJsonResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new FakeJsonResponse($fetched);
        } else {
