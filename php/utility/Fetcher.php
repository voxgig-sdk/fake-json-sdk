...
class FakeJsonFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; FakeJsonSDK/1.0)';
    ...
    public static function call(FakeJsonContext $ctx, string $fullurl, array $fetchdef): array
    {
