...
class FakeJsonCacheFeature extends FakeJsonBaseFeature
{
    ...
    private function _through(FakeJsonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
