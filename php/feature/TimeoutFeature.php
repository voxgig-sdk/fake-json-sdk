...
class FakeJsonTimeoutFeature extends FakeJsonBaseFeature
{
    ...
    private function _with_timeout(FakeJsonContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(FakeJsonContext $_ctx, float $ms): void
    {
        $client = $this->client;
