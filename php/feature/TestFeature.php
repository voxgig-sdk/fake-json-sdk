...
// FakeJson SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class FakeJsonTestFeature extends FakeJsonBaseFeature
{
    ...
    public function init(FakeJsonContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (FakeJsonContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (FakeJsonContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(FakeJsonContext $ctx, $op, $args): array
    {
