...
// FakeJson SDK ratelimit feature
...
class FakeJsonRatelimitFeature extends FakeJsonBaseFeature
{
    ...
    private function _acquire(FakeJsonContext $ctx): void
    {
    ...
    private function _track(FakeJsonContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
