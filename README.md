...
This free public API allows developers to easily obtain fake JSON data for testing and development.

Learn more about Fake JSON API at [softwium.com](https://softwium.com).
...
This SDK exposes the API as a small set of **semantic entities** — Book, Currency, Person and Pokemon — that you
...
$books = $client->Book()->list();
print_r(array_map(fn($item) => $item->data_get(), $books));
