...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/fake-json` | `npm install @voxgig-sdk/fake-json` |
| Python | `voxgig-sdk-fake-json` | `pip install voxgig-sdk-fake-json` |
| PHP | `voxgig-sdk/fake-json` | `composer require voxgig-sdk/fake-json` |
| Golang | `github.com/voxgig-sdk/fake-json-sdk/go` | `go get github.com/voxgig-sdk/fake-json-sdk/go` |
| Ruby | `voxgig-sdk-fake-json` | `gem install voxgig-sdk-fake-json` |
| Lua | `voxgig-sdk-fake-json` | `luarocks install voxgig-sdk-fake-json` |
