...
(0, node_test_1.describe)('CurrencyDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-currency', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-currency', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['FAKE_JSON_TEST_CURRENCY_ENTID'];
...
//# sourceMappingURL=CurrencyDirect.test.js.map