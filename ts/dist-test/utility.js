...
function envOverride(m) {
    if ('TRUE' === process.env.FAKE_JSON_TEST_LIVE ||
        'TRUE' === process.env.FAKE_JSON_TEST_OVERRIDE) {
    ...
    m.FAKE_JSON_TEST_EXPLAIN = process.env.FAKE_JSON_TEST_EXPLAIN || m.FAKE_JSON_TEST_EXPLAIN;
    return m;
}
