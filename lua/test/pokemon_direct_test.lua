...
describe("PokemonDirect", function()
  it("should direct-list-pokemon", function()
    local setup = pokemon_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-pokemon", setup.live and "live" or "unit")
...
function pokemon_direct_setup(mockres)
