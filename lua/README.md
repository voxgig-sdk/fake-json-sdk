...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/fake-json-sdk/releases)),
...
```
lua/
├── fake-json_sdk.lua    -- Main SDK module
...
The main module (`fake-json_sdk`) exports the SDK constructor
