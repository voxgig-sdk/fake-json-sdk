...
type Args struct {
	Entity string         `json:"entity" jsonschema:"book | currency | person | pokemon"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.FakeJsonSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "fake-json_list",
		Description: "List records from FakeJson. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "fake-json_load",
		Description: "Load a single record from FakeJson. " +
...
func runOp(client *sdk.FakeJsonSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.FakeJsonSDK, name string) (sdk.FakeJsonEntity, error) {
