...
class PokemonEntity
  ...
  def make
    opts = @_entopts.dup
    PokemonEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [PokemonListMatch, Hash, nil] match filter (any subset of
  #   Pokemon fields); defaults to nil, treated as an empty match that lists all.
