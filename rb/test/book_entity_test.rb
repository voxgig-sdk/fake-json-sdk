...
class BookEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    book_ref01_data_result, err = book_ref01_ent.create(book_ref01_data, nil)
    assert_nil err
    ...
    book_ref01_resdata_up0_result, err = book_ref01_ent.update(book_ref01_data_up0_up, nil)
    assert_nil err
    ...
    _, err = book_ref01_ent.remove(book_ref01_match_rm0, nil)
    assert_nil err

    # LIST
    book_ref01_match_rt0 = {}

    book_ref01_list_rt0_result, err = book_ref01_ent.list(book_ref01_match_rt0, nil)
    assert_nil err
