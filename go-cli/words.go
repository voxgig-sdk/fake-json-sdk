...
func registerSDKWords(r *eng.Registry, client *sdk.FakeJsonSDK) {
...
func runOp(client *sdk.FakeJsonSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
